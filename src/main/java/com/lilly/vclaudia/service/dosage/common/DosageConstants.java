...
/**
 * Holds the constants used across dosage service.
 * 
 * @author cramaswamy
 *
 */
public interface DosageConstants {

	public static final String DOSAGE_SCHEDULE_REQUIRED_IN_YEARS = "dosageScheduleRequiredInYears";
